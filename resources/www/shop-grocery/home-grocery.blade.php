              ...
              <div class="container mt-lg-n4">
                <div class="row">
                  <div class="col-9 col-sm-8 col-md-7 col-lg-6">
                    ...
                    <a class="btn btn-lg btn-outline-light rounded-pill" href="shop-catalog-grocery">Shop now</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide h-auto">
            <div class="position-relative d-flex justify-content-between align-items-center h-100 bg-primary-subtle rounded-5 overflow-hidden ps-2 ps-xl-3">
              <div class="d-flex flex-column pt-4 px-3 pb-3">
                ...
                <div class="nav">
                  <a class="nav-link animate-underline stretched-link text-body-emphasis text-nowrap px-0" href="shop-catalog-grocery">
            ...
            <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
              <div class="position-relative d-flex min-w-0 align-items-center">
                ...
                <div class="min-w-0 ps-3">
                  <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1" href="shop-catalog-grocery">
              ...
              <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                ...
                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                  ...
                  <h3 class="fs-sm lh-base mb-0">
                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Muesli Fitness Energy, gluten free</a>
                  </h3>
                </div>
            ...
            <div class="col">
              <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                ...
                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                  ...
                  <h3 class="fs-sm lh-base mb-0">
                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Fresh mango, Spain</a>
                  </h3>
                </div>
            ...
            <div class="col">
              <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                ...
                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                  ...
                  <h3 class="fs-sm lh-base mb-0">
                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Fresh green asparagus, bunch</a>
                  </h3>
                </div>
              ...
              <div class="swiper-slide h-auto">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  ...
                  <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                    ...
                    <h3 class="fs-sm lh-base mb-0">
                      <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Fresh pork butt steaks with rosemary</a>
                    </h3>
                  </div>
                  <div class="fs-xs text-body-secondary px-1 px-md-2 px-lg-3 pb-2 pb-md-3">500g</div>
                </div>
              ...
              <div class="swiper-slide h-auto">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  ...
                  <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                    ...
                    <h3 class="fs-sm lh-base mb-0">
                      <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Fresh red grapefruit</a>
                    </h3>
                  </div>
                  <div class="fs-xs text-body-secondary px-1 px-md-2 px-lg-3 pb-2 pb-md-3">1kg</div>
                </div>
              ...
              <div class="swiper-slide h-auto">
                <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                  ...
                  <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                    ...
                    <h3 class="fs-sm lh-base mb-0">
                      <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Soft creme cheese with greens Exquisa</a>
                    </h3>
                  </div>
