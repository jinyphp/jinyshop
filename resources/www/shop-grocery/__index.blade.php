          ...
          "disableOnInteraction": false
            ...
            <div class="swiper-wrapper">
                            ...
                            <div class="row">
                                <div class="col-9 col-sm-8 col-md-7 col-lg-6">
                                    ...
                                    <a class="btn btn-lg btn-outline-light rounded-pill"
                                        href="shop-catalog-grocery">Shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <img src="/assets/img/home/grocery/hero-slider/01.jpg"
                ...
                <div class="swiper-slide" style="background-color: #5a7978">
                    ...
                    <img src="/assets/img/home/grocery/hero-slider/02.jpg"
                        class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                </div>
                ...
                <div class="swiper-slide" style="background-color: #f99c03">
                    ...
                    <img src="/assets/img/home/grocery/hero-slider/03.jpg"
                        class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 pb-md-4 mb-3 mb-lg-4">
                    ...
                    <div class="nav ms-3">
                        <a class="nav-link animate-underline px-0 py-2" href="shop-catalog-grocery">
                        ...
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Muesli
                                        Fitness Energy, gluten free</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Fresh
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Pepsi soda
                                        classic, can</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Mozzarella
                                        mini cheese Granaloro</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Coconut,
                                        Indonesia</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Pesto
          ...
          "992": {
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide text-center">
                    ...
                    <h3 class="h5 mb-2">
                        <a class="animate-underline stretched-link" href="shop-catalog-grocery">
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Pure
                                            virgin olive oil Basso</a>
                                    </h3>
                                </div>
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Fresh
                                            pork butt steaks with rosemary</a>
                                    </h3>
                                </div>
                                <div class="fs-xs text-body-secondary px-1 px-md-2 px-lg-3 pb-2 pb-md-3">500g</div>
                            </div>
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal" href="shop-product-grocery">Soft
                                            creme cheese with greens Exquisa</a>
                                    </h3>
                                </div>
            ...
            <div class="col-lg-5 mb-4 mb-lg-0">
                <div class="d-flex flex-column gap-1 gap-md-2">
                    ...
                    <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                        ...
                        <div class="ps-3 ps-xl-4">
                            <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
                                <a class="hover-effect-underline stretched-link" href="#!">Garden salad with a
                                    mix of lettuce, cucumber and tomato</a>
                            </h3>
                    ...
                    <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                        ...
                        <div class="ps-3 ps-xl-4">
                            <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
                                <a class="hover-effect-underline stretched-link" href="#!">Raspberry fresh
                                    lemonade with lemon, strawberry syrup and mint</a>
                            </h3>
                            <div class="d-flex gap-3 gap-xl-4 fs-sm text-body-secondary">
                                <div class="d-flex align-items-center text-nowrap">
                                    <i class="ci-clock fs-base me-2"></i>
                    ...
                    <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                        ...
                        <div class="ps-3 ps-xl-4">
                            <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
                                <a class="hover-effect-underline stretched-link" href="#!">Penne pasta with
                                    spinach and zucchini in a creamy sauce</a>
                            </h3>
                            <div class="d-flex gap-3 gap-xl-4 fs-sm text-body-secondary">
                                <div class="d-flex align-items-center text-nowrap">
                                    <i class="ci-clock fs-base me-2"></i>
            ...
            <div class="col-lg-7">
                <div class="border rounded-5 p-4">
                    <div
                        ...
                        <a class="ratio d-block w-100 mb-4 mb-sm-0" href="#!"
                            style="--cz-aspect-ratio: calc(404 / 286 * 100%); max-width: 286px">
                            <img src="/assets/img/home/grocery/recipes/book-cover.jpg" class="rounded-4"
                                alt="Book cover">
                        </a>
                        <div class="w-100 ps-sm-4 ms-md-2 ms-lg-0 ms-xl-2 ms-xxl-3">
                            ...
                            <div class="fs-sm mb-3">Author: <span class="text-dark-emphasis fw-medium">Dana
                                    Chambers</span></div>
                            <p class="fs-sm pb-1 pb-xl-3">An exquisite cookbook that takes readers on a culinary
                                journey around the world. With stunning photography and detailed instructions ...</p>
