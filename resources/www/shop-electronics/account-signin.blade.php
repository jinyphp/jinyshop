    ...
    <div class="d-lg-flex">
      ...
      <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
        ...
        <div class="nav fs-sm mb-4">
          ...
          <a class="nav-link text-decoration-underline p-0 ms-2" href="account-signup">Create an account</a>
        </div>
        ...
        <footer class="mt-auto">
          <div class="nav mb-4">
            <a class="nav-link text-decoration-underline p-0" href="help-topics-v1">Need help?</a>
          </div>
          <p class="fs-xs mb-0">
